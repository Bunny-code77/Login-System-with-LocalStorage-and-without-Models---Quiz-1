import { CalendarDays, Clock, Hash, TrendingUp, Users } from "lucide-react";
...
export default function Dashboard() {
  ...
  const upcoming = [
    { platform: "Instagram", date: "Oct 12, 2025", time: "3:00 PM", status: "Scheduled" },
    { platform: "Facebook", date: "Oct 13, 2025", time: "6:00 PM", status: "Pending" },
    { platform: "LinkedIn", date: "Oct 15, 2025", time: "9:30 AM", status: "Scheduled" },
  ];
      ...
      <section className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="text-gray-600 leading-relaxed mb-5">
            Your posts are performing better than last week 🎉. Engagement is up by 12%, 
            and your followers have grown steadily. Keep posting consistently and using 
            trending hashtags to maintain momentum.
          </p>
