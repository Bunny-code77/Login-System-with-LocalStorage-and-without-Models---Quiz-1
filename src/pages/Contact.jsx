...
export default function Contact() {
  return (
    <section className="py-24 bg-gradient-to-b from-purple-50 to-purple-100">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="bg-white p-10 rounded-3xl shadow-2xl border border-purple-100 relative">
          ...
          <p className="text-gray-600 text-center mb-8">
            Have a question or want to collaborate? Fill out the form and our team will get back to you soon.
          </p>
          ...
          <div className="mt-8 space-y-3 text-sm text-gray-600">
            <div className="flex items-center gap-2">
              <Mail className="text-purple-600" size={18} /> support@postplanner.com
            </div>
            <div className="flex items-center gap-2">
              <Phone className="text-purple-600" size={18} /> +92 300 1234567
            </div>
            <div className="flex items-center gap-2">
              <MapPin className="text-purple-600" size={18} /> Lahore, Pakistan
            </div>
          </div>
        </div>
      </div>
